...
#Factory.register('InstallWizard', module='electrum_gxx_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_gxx_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_gxx_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_gxx_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_gxx_gui.kivy.uix.screens')
...
from electrum_gxx.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_gxx.bitcoin import NetworkConstants
    ...
    def on_new_intent(self, intent):
        if intent.getScheme() != 'gravitycoin':
            return
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'GXX')
    ...
    def __init__(self, **kwargs):
        ...
        title = _('Electrum-Gravitycoin App')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_gxx_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_gxx_gui.kivy.uix.qrcodewidget')
        ...
        self.icon = "icons/electrum-gravitycoin.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-Gravitycoin', message,
                            app_icon=icon, app_name='Electrum-Gravitycoin')
        except ImportError:
