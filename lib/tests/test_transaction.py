...
class TestTransaction(unittest.TestCase):
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(estimated_output_size('gxx1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e'), 31)
        self.assertEqual(estimated_output_size('gxx1qnvks7gfdu72de8qv6q6rhkkzu70fqz4wpjzuxjf6aydsx7wxfwcqsmgvk5'), 43)
